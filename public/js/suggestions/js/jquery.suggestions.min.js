!function (e, t) {
  ...
  var m = {
    ...
    D = [{id: "kladr_id", fields: ["kladr_id"], forBounds: !1, forLocations: !0}, {
      ...
      composeValue: function (e, t) {
        var n = e.country, i = e.region_with_type || y.compact([e.region, e.region_type]).join(" ") || e.region_type_full,
          ...
          u = y.compact([e.flat_type, e.flat]).join(" "), d = e.postal_box && "а/я " + e.postal_box;
      ...
      formatResult: function () {
        ...
        return D.forEach(function (n) {
          ...
          var o, a, r, l = this, c = i.data && i.data.city_district_with_type, u = s && s.unformattableTokens,
      ...
      matchers: [O.matchByFields({value: null, "data.address.value": R, "data.inn": null, "data.ogrn": null})],
      dataComponents: D,
      enrichmentEnabled: !0,
      ...
      formatResult: function (e, t, n, o) {
        var a = this, r = a.type.formatResultInn.call(a, n, t),
          l = a.highlightMatches(b.getDeepValue(n.data, "ogrn"), t, n), c = i(r, l),
          u = a.highlightMatches(b.getDeepValue(n.data, "management.name"), t, n),
          d = b.getDeepValue(n.data, "address.value") || "";
        return a.isMobile && ((o || (o = {})).maxLength = 50), e = s.call(a, e, b.getDeepValue(n.data, "name.latin"), t, n, o), e = a.wrapFormattedValue(e, n), d && (d = d.replace(/^(\d{6}?\s+|Россия,\s+)/i, ""), d = a.isMobile ? d.replace(new RegExp("^([^" + w + "]+[" + w + "]+[^" + w + "]+).*"), "$1") : a.highlightMatches(d, t, n, {unformattableTokens: R})), (c || d || u) && (e += '<div class="' + a.classes.subtext + '"><span class="' + a.classes.subtext_inline + '">' + (c || "") + "</span>" + (i(d, u) || "") + "</div>"), e
      },
      ...
      matchers: [O.matchByFields({value: null, "data.bic": null, "data.swift": null})],
      dataComponents: D,
      geoEnabled: !0,
    ...
    }, N = {NAME: q, ADDRESS: I, PARTY: $, EMAIL: A, BANK: z};
  N.get = function (e) {
  ...
  a.prototype = {
    initialize: function () {
      ...
      var n = this;
      e.extend(n.options, t), n.type = N.get(n.options.type), e.each({requestMode: U}, function (t, i) {
      ...
      var i = this, s = e.trim(i.options.token), o = e.trim(i.options.partner), r = i.options.serviceUrl,
        l = i.options.url, c = H[t], u = e.extend({timeout: i.options.timeout}, c.defaultParams), d = {};
      ...
      var s, o = this, a = o.options, r = i && i.noCallbacks, l = i && i.useEnrichmentCache,
        c = i && i.method || o.requestMode.method, u = o.constructRequestParams(t, n), d = e.param(u || {}),
        f = e.Deferred();
  ...
  var Y = {width: "auto", floating: !1}, ee = {
    createContainer: function () {
      ...
      var i, s, o = this, a = o.type.fieldNames, r = {}, l = j.reWordExtractor(), c = [];
