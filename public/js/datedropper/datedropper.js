		...
		return $(this).each(function(){
			if($(this).is('input')&&!$(this).hasClass('picker-input')) {
				...
				var
					...
					picker_lang = (input.data('lang')&&(input.data('lang') in i18n)) ? input.data('lang') : 'ru',
					picker_large = (input.data('large-mode')===true) ? true : true,
					picker_large_class = (input.data('large-default')===true && picker_large===true) ? 'picker-lg' : 'picker-lg',
                    ...
                    picker_text_input = (input.data('text-input') === true) ? input.data('text-input') : true,
